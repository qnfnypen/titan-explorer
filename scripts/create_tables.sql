...
CREATE TABLE `storage_hour` (
    ...
    `user_id` VARCHAR(128) NOT NULL DEFAULT '',
    `time` TIMESTAMP NOT NULL DEFAULT 0,
    `total_storage_size` int(32) NOT NULL DEFAULT '0',
    `used_storage_size` int(32) NOT NULL DEFAULT '0',
    `total_bandwidth` int(32) NOT NULL DEFAULT '0',
    `peak_bandwidth` int(32) NOT NULL DEFAULT '0',
